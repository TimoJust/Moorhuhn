...
class Startseite_Optik(IDisplay_Hintergrund_Behavior):
    def display(self):
        ...
        spielbeschreibung = font.render("Der Weingott Dionysos lässt Bier vom Himmel regnen und bereitet Dir ein grandioses", True, (0, 0, 0))
        spielbeschreibung_position = (30,200)
        screen.blit(spielbeschreibung,spielbeschreibung_position)
        spielbeschreibung = font.render("Fest. Sammle alle Biere und Schnäpse und werde zum ultimativen Bierkönig.", True, (0, 0, 0))
        spielbeschreibung_position = (30,240)
        screen.blit(spielbeschreibung,spielbeschreibung_position)
        spielbeschreibung = font.render("Doch Achtung die Göttin Hera ist nicht zur Feier eingeladen und versucht Euer Fest", True, (0, 0, 0))
        spielbeschreibung_position = (30,280)
        screen.blit(spielbeschreibung,spielbeschreibung_position)
        spielbeschreibung = font.render("zu verhindern indem Sie Wasser vom Himmel regnen lässt.", True, (0, 0, 0))
        spielbeschreibung_position = (30,320)
        screen.blit(spielbeschreibung,spielbeschreibung_position)
        spielbeschreibung = font.render("In diesem Spiel geht es darum so viel Bier wie möglich einzusammeln bevor das Fest", True, (0, 0, 0))
        spielbeschreibung_position = (30,360)
        screen.blit(spielbeschreibung,spielbeschreibung_position)
        spielbeschreibung = font.render("zu Ende ist. Hier können sich echte Helden in Ihrem Geschick beweisen.", True, (0, 0, 0))
